...
import { bookmarkNameForId } from '../schema/ids';
import { base64ToBytes } from '../ooxml/base64';
import type { Thread } from '../editor/comments-plugin';
import { assignDocxNumbering, buildNumberingXml, numPrXml } from './docx-numbering';
import type { FootnoteContent, FootnoteRun } from '../schema/footnotes';
